...
/**
 * AgentChangeStateHandler unit testing.
 */
public class AgentChangeStateHandlerTestSuite {
    ...
    private AgentChangeStateHandler agentChangeStateHandler;
    ...
    public void setUp() throws Exception {
        ...
        agentChangeStateHandler = new AgentChangeStateHandler();
    }
    ...
    public void testChannelRead0() throws Exception {
        ...
        ChangeState message = new ChangeState(new Node((short) 1, NodeType.GATEWAY, State.CONNECTED));
        agentChangeStateHandler.channelRead0(context, message);
    }

    @Test
    public void testChannelActive() throws Exception {
        agentChangeStateHandler.channelActive(context);
        agentChangeStateHandler.channelInactive(context);
    }
}
